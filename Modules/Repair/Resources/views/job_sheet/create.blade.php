...
<section class="content">
        ...
        <div class="box box-solid">
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        {!! Form::label('service_type',  __('repair::lang.channel').':*', ['style' => 'margin-left:20px;'])!!}
                        <br>
        ...
        <div class="box box-solid">
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            {!! Form::label('serial_no', __('repair::lang.vehicle_registration') . ':*') !!}
                            {!! Form::text('serial_no', null, ['class' => 'form-control', 'placeholder' => __('repair::lang.vehicle_registration'), 'required']); !!}
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                           {!! Form::label('security_pwd', __('repair::lang.security_immobiliser_notes') . ':') !!}
                            <div class="input-group">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('product_configuration', __('repair::lang.manager_notes') . ':') !!} <br>
                           {!! Form::textarea('product_configuration', null, ['class' => 'tags-look', 'rows' => 3]); !!}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('defects', __('repair::lang.customer_notes') . ':') !!} <br>
                            {!! Form::textarea('defects', null, ['class' => 'tags-look', 'rows' => 3]); !!}
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            {!! Form::label('product_condition', __('repair::lang.any_damages') . ':') !!} <br>
    ...
    <div class="modal fade vehicle_colour_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"></div>
</section>
@stop
@section('css')
...
@section('javascript')
    ...
    <script src="{{ asset('js/job_sheet_add.js?v=' . $asset_v) }}"></script>
    <script type="text/javascript">
        $('#brand_id').on('select2:open', () => {
            $(".select2-results:not(:has(a))").append('<div class="select2-add-item"><a href="javascript:void(0)" @if(!auth()->user()->can('brand.create')) disabled @endif class="btn-modal quick_add_brand" data-href="{{action('BrandController@create', ['quick_add' => true, 'on_repair' => true])}}" title="Add Vehicle Make" data-container=".view_modal"><i class="fa fa-plus-circle fa-lg"></i></i>Add Vehicle Make</a></div>');
        });
        $('#device_id').on('select2:open', () => {
            $(".select2-results:not(:has(a))").append('<div class="select2-add-item"><a href="javascript:void(0)" @if(!auth()->user()->can('category.create')) disabled @endif class="btn-modal" data-href="{{action('TaxonomyController@create', ['type' => 'device'])}}" title="Add Vehicle Model" data-container=".category_modal"><i class="fa fa-plus-circle fa-lg"></i></i>Add Vehicle Model</a></div>');
        });
        $('#device_model_id').on('select2:open', () => {
            $(".select2-results:not(:has(a))").append('<div class="select2-add-item"><a href="javascript:void(0)" class="btn-modal" data-href="{{action('\Modules\Repair\Http\Controllers\DeviceModelController@create')}}" title="Add Vehicle Colour" data-container=".vehicle_colour_modal"><i class="fa fa-plus-circle fa-lg"></i></i>Add Vehicle Colour</a></div>');
        });
