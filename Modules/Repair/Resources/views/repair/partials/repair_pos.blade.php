...
<div class="row">
	<div class="col-sm-4">
		<div class="form-group">
			{!! Form::label('repair_brand_id', __('repair::lang.vehicle_make') . ':') !!}
	...
	<div class="col-sm-4">
		<div class="form-group">
			{!! Form::label('repair_device_id', __('repair::lang.vehicle_model') . ':') !!}
	...
	<div class="col-sm-4">
		<div class="form-group">
			{!! Form::label('repair_model_id', __('repair::lang.vehicle_colour') . ':') !!}
...
<div class="row">
	<div class="col-sm-4">
		<div class="form-group">
			{!! Form::label('repair_serial_no', __('repair::lang.vehicle_registration') . ':') !!}
