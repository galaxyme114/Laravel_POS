<div class="modal-dialog" role="document">
  <div class="modal-content">
    ...
    <div class="modal-header">
      ...
      <h4 class="modal-title">@lang( 'brand.add_vehicle_make' )</h4>
    </div>

    <div class="modal-body">
      <div class="form-group">
        {!! Form::label('name', __( 'brand.vehicle_make_name' ) . ':*') !!}
          {!! Form::text('name', null, ['class' => 'form-control', 'required', 'placeholder' => __( 'brand.vehicle_make_name' ) ]); !!}
      </div>
      ...
      <div class="form-group">
        ...
        @if($is_repair_installed)
          <div class="form-group <?= $is_use_for_repair ? 'hidden' : '' ?>">
             <label>
                {!!Form::checkbox('use_for_repair', 1, $is_use_for_repair ? true : false, ['class' => 'input-icheck']) !!}
